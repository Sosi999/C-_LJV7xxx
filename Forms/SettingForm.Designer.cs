namespace LJV7_DllSampleAll.Forms
{
	partial class SettingForm
	{
		...
		private void InitializeComponent()
		{
			...
			this._lblHexType.Location = new System.Drawing.Point(14, 106);
			this._lblHexType.Name = "_lblHexType";
			this._lblHexType.Size = new System.Drawing.Size(19, 13);
			this._lblHexType.TabIndex = 0;
			this._lblHexType.Text = "0x";
			// 
			// _txtboxType
			// 
			this._txtboxType.Location = new System.Drawing.Point(37, 103);
			this._txtboxType.MaxLength = 2;
			this._txtboxType.Name = "_txtboxType";
			this._txtboxType.Size = new System.Drawing.Size(76, 21);
			this._txtboxType.TabIndex = 1;
			this._txtboxType.Text = "10";
			// 
			// _lblType
			// 
			this._lblType.AutoSize = true;
			this._lblType.Location = new System.Drawing.Point(119, 106);
			this._lblType.Name = "_lblType";
			this._lblType.Size = new System.Drawing.Size(66, 13);
			this._lblType.TabIndex = 2;
			this._lblType.Text = "Setting type";
			// 
			// _lblCategor
			// 
			this._lblCategor.AutoSize = true;
			this._lblCategor.Location = new System.Drawing.Point(119, 178);
			this._lblCategor.Name = "_lblCategor";
			this._lblCategor.Size = new System.Drawing.Size(52, 13);
			this._lblCategor.TabIndex = 5;
			this._lblCategor.Text = "Category";
			// 
			// _txtboxCategor
			// 
			this._txtboxCategor.Location = new System.Drawing.Point(37, 174);
			...
			this._txtboxCategor.TabIndex = 2;
			this._txtboxCategor.Text = "00";
			// 
			// _lblHexCategor
			// 
			this._lblHexCategor.AutoSize = true;
			this._lblHexCategor.Location = new System.Drawing.Point(14, 178);
			this._lblHexCategor.Name = "_lblHexCategor";
			this._lblHexCategor.Size = new System.Drawing.Size(19, 13);
			this._lblHexCategor.TabIndex = 3;
			this._lblHexCategor.Text = "0x";
			// 
			// _lblItem
			// 
			this._lblItem.AutoSize = true;
			this._lblItem.Location = new System.Drawing.Point(119, 209);
			this._lblItem.Name = "_lblItem";
			this._lblItem.Size = new System.Drawing.Size(64, 13);
			this._lblItem.TabIndex = 8;
			this._lblItem.Text = "Setting item";
			// 
			// _txtboxItem
			// 
			this._txtboxItem.Location = new System.Drawing.Point(37, 206);
			this._txtboxItem.MaxLength = 2;
			this._txtboxItem.Name = "_txtboxItem";
			this._txtboxItem.Size = new System.Drawing.Size(76, 21);
			this._txtboxItem.TabIndex = 3;
			this._txtboxItem.Text = "02";
			// 
			// _lblHexItem
			// 
			this._lblHexItem.AutoSize = true;
			this._lblHexItem.Location = new System.Drawing.Point(14, 209);
			this._lblHexItem.Name = "_lblHexItem";
			this._lblHexItem.Size = new System.Drawing.Size(19, 13);
			this._lblHexItem.TabIndex = 6;
			this._lblHexItem.Text = "0x";
			// 
			// _lblTarget1
			// 
			this._lblTarget1.AutoSize = true;
			this._lblTarget1.Location = new System.Drawing.Point(119, 241);
			this._lblTarget1.Name = "_lblTarget1";
			this._lblTarget1.Size = new System.Drawing.Size(83, 13);
			this._lblTarget1.TabIndex = 11;
			this._lblTarget1.Text = "Setting target 1";
			// 
			// _txtboxTarget1
			// 
			this._txtboxTarget1.Location = new System.Drawing.Point(37, 237);
			...
			this._txtboxTarget1.TabIndex = 4;
			this._txtboxTarget1.Text = "00";
			// 
			// _lblHexTarget1
			// 
			this._lblHexTarget1.AutoSize = true;
			this._lblHexTarget1.Location = new System.Drawing.Point(14, 241);
			this._lblHexTarget1.Name = "_lblHexTarget1";
			this._lblHexTarget1.Size = new System.Drawing.Size(19, 13);
			this._lblHexTarget1.TabIndex = 9;
			this._lblHexTarget1.Text = "0x";
			// 
			// _lblTarget2
			// 
			this._lblTarget2.AutoSize = true;
			this._lblTarget2.Location = new System.Drawing.Point(119, 272);
			this._lblTarget2.Name = "_lblTarget2";
			this._lblTarget2.Size = new System.Drawing.Size(83, 13);
			this._lblTarget2.TabIndex = 14;
			this._lblTarget2.Text = "Setting target 2";
			// 
			// _txtboxTarget2
			// 
			this._txtboxTarget2.Location = new System.Drawing.Point(37, 269);
			...
			this._txtboxTarget2.TabIndex = 5;
			this._txtboxTarget2.Text = "00";
			// 
			// _lblHexTarget2
			// 
			this._lblHexTarget2.AutoSize = true;
			this._lblHexTarget2.Location = new System.Drawing.Point(14, 272);
			this._lblHexTarget2.Name = "_lblHexTarget2";
			this._lblHexTarget2.Size = new System.Drawing.Size(19, 13);
			this._lblHexTarget2.TabIndex = 12;
			this._lblHexTarget2.Text = "0x";
			// 
			// _lblTarget3
			// 
			this._lblTarget3.AutoSize = true;
			this._lblTarget3.Location = new System.Drawing.Point(119, 303);
			this._lblTarget3.Name = "_lblTarget3";
			this._lblTarget3.Size = new System.Drawing.Size(83, 13);
			this._lblTarget3.TabIndex = 17;
			this._lblTarget3.Text = "Setting target 3";
			// 
			// _txtboxTarget3
			// 
			this._txtboxTarget3.Location = new System.Drawing.Point(37, 300);
			...
			this._txtboxTarget3.TabIndex = 6;
			this._txtboxTarget3.Text = "00";
			// 
			// _lblHexTarget3
			// 
			this._lblHexTarget3.AutoSize = true;
			this._lblHexTarget3.Location = new System.Drawing.Point(14, 303);
			this._lblHexTarget3.Name = "_lblHexTarget3";
			this._lblHexTarget3.Size = new System.Drawing.Size(19, 13);
			this._lblHexTarget3.TabIndex = 15;
			this._lblHexTarget3.Text = "0x";
			// 
			// _lblTarget4
			// 
			this._lblTarget4.AutoSize = true;
			this._lblTarget4.Location = new System.Drawing.Point(119, 335);
			this._lblTarget4.Name = "_lblTarget4";
			this._lblTarget4.Size = new System.Drawing.Size(83, 13);
			this._lblTarget4.TabIndex = 20;
			this._lblTarget4.Text = "Setting target 4";
			// 
			// _txtboxTarget4
			// 
			this._txtboxTarget4.Location = new System.Drawing.Point(37, 332);
			...
			this._txtboxTarget4.TabIndex = 7;
			this._txtboxTarget4.Text = "00";
			// 
			// _lblHexTarget4
			// 
			this._lblHexTarget4.AutoSize = true;
			this._lblHexTarget4.Location = new System.Drawing.Point(14, 335);
			this._lblHexTarget4.Name = "_lblHexTarget4";
			this._lblHexTarget4.Size = new System.Drawing.Size(19, 13);
			this._lblHexTarget4.TabIndex = 18;
			this._lblHexTarget4.Text = "0x";
			// 
			// _lblDepth
			// 
			this._lblDepth.AutoSize = true;
			this._lblDepth.Location = new System.Drawing.Point(119, 56);
			this._lblDepth.Name = "_lblDepth";
			this._lblDepth.Size = new System.Drawing.Size(170, 13);
			this._lblDepth.TabIndex = 23;
			this._lblDepth.Text = "Get target area and setting depth";
			// 
			// _txtboxDepth
			// 
			this._txtboxDepth.Location = new System.Drawing.Point(37, 53);
			this._txtboxDepth.MaxLength = 2;
			this._txtboxDepth.Name = "_txtboxDepth";
			this._txtboxDepth.Size = new System.Drawing.Size(76, 21);
			this._txtboxDepth.TabIndex = 0;
			this._txtboxDepth.Text = "01";
			// 
			// _lblHexDepth
			// 
			this._lblHexDepth.AutoSize = true;
			this._lblHexDepth.Location = new System.Drawing.Point(14, 56);
			this._lblHexDepth.Name = "_lblHexDepth";
			this._lblHexDepth.Size = new System.Drawing.Size(19, 13);
			this._lblHexDepth.TabIndex = 21;
			this._lblHexDepth.Text = "0x";
			// 
			// _lblParameter
			// 
			this._lblParameter.AutoSize = true;
			this._lblParameter.Location = new System.Drawing.Point(14, 389);
			this._lblParameter.Name = "_lblParameter";
			this._lblParameter.Size = new System.Drawing.Size(292, 13);
			this._lblParameter.TabIndex = 24;
			this._lblParameter.Text = "Writing parameters (comma-separated hexadecimal values)";
			// 
			// _txtboxParameter
			// 
			this._txtboxParameter.Location = new System.Drawing.Point(16, 405);
			...
			this._txtboxParameter.TabIndex = 9;
			this._txtboxParameter.Text = "3";
			// 
			// _btnCancel
			// 
			this._btnCancel.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			this._btnCancel.Location = new System.Drawing.Point(211, 484);
			...
			this._btnOk.Location = new System.Drawing.Point(67, 484);
			...
			this.label5.Location = new System.Drawing.Point(163, 366);
